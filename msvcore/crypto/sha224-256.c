...
static int SHA224_256Reset(SHA256Context *context, uint32_t *H0_);
 ...
 *   sha Error Code.
 */
static int SHA224_256Reset(SHA256Context *context, uint32_t *_H0)
{
  if (!context)
    return shaNull;
  ...
  context->Intermediate_Hash[0] = _H0[0];
  context->Intermediate_Hash[1] = _H0[1];
  context->Intermediate_Hash[2] = _H0[2];
  context->Intermediate_Hash[3] = _H0[3];
  context->Intermediate_Hash[4] = _H0[4];
  context->Intermediate_Hash[5] = _H0[5];
  context->Intermediate_Hash[6] = _H0[6];
  context->Intermediate_Hash[7] = _H0[7];
